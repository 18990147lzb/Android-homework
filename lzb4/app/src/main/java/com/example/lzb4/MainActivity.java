...
import com.example.lzb4.bean.UserInfo;
import com.example.lzb4.database.UserDBHelper;
import com.example.lzb4.util.DateUtil;
import com.example.lzb4.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","李中北-18990147"};
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 选择了密码方式校验，此时要跳到找回密码页面
                Intent intent = new Intent(this, com.example.lzb4.LoginForgetActivity.class);
                // 携带手机号码跳转到找回密码页面
